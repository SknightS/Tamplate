...
class CompanyController extends Controller
{
    ...
    {
        $allCompaniesWithBranch= Companybranch::select('company_branch.id','company_branch.image','company_branch.name as branchName','company_branch.address_addressId',
...
//                        ->leftJoin('company', 'company_branch.company_companyId', '=', 'company.companyId')
    ...
    {
        $companyDetails = Companybranch::findOrFail($id);
